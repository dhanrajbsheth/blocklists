This is a list of domains associated with websites which needs to be blocked on home, office, uni network. It was compiled keeping in mind only simple domain list which can be used as blocklist.
